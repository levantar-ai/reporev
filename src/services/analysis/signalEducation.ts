...
export const SIGNAL_EDUCATION: Record<string, SignalEducation> = {
  ...
  'README exists': {
    ...
    howToFix: 'Create a README.md at the repository root with a description, installation instructions, and usage examples.',
  ...
  'Substantial README (>500 chars)': {
    ...
    howToFix: 'Expand your README with sections: Description, Installation, Usage, Configuration, Contributing, and License.',
  },
  'README has sections': {
    ...
    howToFix: 'Add markdown headers (## Section Name) for key sections like Installation, Usage, API, and Contributing.',
  },
  'Code examples in README': {
    ...
    howToFix: 'Add fenced code blocks (```language) with common usage patterns and expected output.',
  },
  'CONTRIBUTING.md': {
    ...
    howToFix: 'Create a CONTRIBUTING.md with development setup instructions, coding standards, and PR guidelines.',
  ...
  'docs/ directory': {
    ...
    howToFix: 'Create a docs/ directory with additional guides, API references, or architecture decisions.',
  },
  ...
  'SECURITY.md': {
    ...
    howToFix: 'Create a SECURITY.md with your vulnerability reporting process, expected response time, and supported versions.',
    fixUrl: 'https://github.com/{owner}/{repo}/new/{branch}?filename=SECURITY.md',
    learnMoreUrl: 'https://docs.github.com/en/code-security/getting-started/adding-a-security-policy-to-your-repository',
  },
  'CODEOWNERS': {
    name: 'CODEOWNERS',
    category: 'security',
    ...
    howToFix: 'Create a CODEOWNERS file mapping directories and file patterns to responsible teams or individuals.',
    fixUrl: 'https://github.com/{owner}/{repo}/new/{branch}?filename=.github/CODEOWNERS',
    learnMoreUrl: 'https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/about-code-owners',
  },
  'Dependabot configured': {
    ...
    howToFix: 'Create .github/dependabot.yml specifying your package ecosystems and update schedule.',
    fixUrl: 'https://github.com/{owner}/{repo}/new/{branch}?filename=.github/dependabot.yml',
    learnMoreUrl: 'https://docs.github.com/en/code-security/dependabot/dependabot-version-updates/configuration-options-for-the-dependabot.yml-file',
  },
  'CodeQL / security scanning': {
    ...
    fixUrl: 'https://github.com/{owner}/{repo}/new/{branch}?filename=.github/workflows/codeql-analysis.yml',
    learnMoreUrl: 'https://docs.github.com/en/code-security/code-scanning/automatically-scanning-your-code-for-vulnerabilities-and-errors/about-code-scanning',
  },
  ...
  '.gitignore present': {
    ...
    howToFix: 'Create a .gitignore file appropriate for your language/framework. GitHub provides templates at github.com/github/gitignore.',
  ...
  'No exposed secret files': {
    ...
    howToFix: 'Remove secret files from the repository, rotate any exposed credentials, and add them to .gitignore.',
  },
  ...
  'GitHub Actions workflows': {
    ...
    howToFix: 'Create a .github/workflows/ directory with YAML workflow files for your CI/CD pipeline.',
  ...
  'CI workflow (test/build)': {
    ...
    howToFix: 'Add a workflow that triggers on push and pull_request events and runs your test suite.',
    fixUrl: 'https://github.com/{owner}/{repo}/new/{branch}?filename=.github/workflows/ci.yml',
  },
  'Deploy / release workflow': {
    ...
    howToFix: 'Create a workflow that triggers on tag push or release events to automate deployment.',
  ...
  'Docker Compose': {
    ...
    howToFix: 'Create a docker-compose.yml defining your application services, databases, and other dependencies.',
  ...
  'Dependency manifest': {
    ...
    howToFix: 'Initialize your project with the appropriate package manager (npm init, cargo init, go mod init, etc.).',
  },
  'Lockfile present': {
    ...
    howToFix: 'Run your package manager install command to generate a lockfile, then commit it to the repository.',
  },
  'Dependencies tracked': {
    ...
    howToFix: 'List all runtime and development dependencies in your manifest file instead of relying on global installs.',
  },
  'Reasonable dependency count': {
    ...
    howToFix: 'Audit your dependencies periodically. Remove unused packages and consider lighter alternatives for heavy ones.',
  },
  ...
  'Linter configured': {
    ...
    howToFix: 'Add a linter config file (e.g., .eslintrc.json for JavaScript, .pylintrc for Python) and run it in CI.',
  ...
  'Formatter configured': {
    ...
    howToFix: 'Add a formatter config (e.g., .prettierrc for Prettier, rustfmt.toml for Rust) and integrate it with your editor and CI.',
  ...
  'Type system': {
    ...
    howToFix: 'Add TypeScript (tsconfig.json) for JavaScript projects, or use type hints for Python projects.',
  ...
  'Tests present': {
    ...
    howToFix: 'Create a test/ or __tests__/ directory and add unit tests using your language testing framework (Jest, pytest, go test, etc.).',
  },
  'CI runs tests': {
    name: 'CI runs tests',
    category: 'codeQuality',
  ...
  'EditorConfig': {
    ...
    howToFix: 'Create a .editorconfig file specifying indent style, indent size, and end-of-line preferences.',
  ...
  'License file exists': {
    ...
    howToFix: 'Add a LICENSE file. Use choosealicense.com to select the right license for your project.',
  ...
  'SPDX license detected': {
    ...
    howToFix: 'Use a standard license text (MIT, Apache-2.0, etc.) so GitHub can automatically detect and display it.',
  },
  'Permissive license': {
    ...
    howToFix: 'Consider using MIT or Apache-2.0 if you want broad adoption with minimal restrictions.',
  },
  'Copyleft license': {
    ...
    howToFix: 'This is informational. Copyleft is a valid choice if you want to ensure derivatives remain open source.',
  },
  ...
  'Issue templates': {
    ...
    howToFix: 'Create .github/ISSUE_TEMPLATE/ directory with templates for bug reports and feature requests.',
    fixUrl: 'https://github.com/{owner}/{repo}/new/{branch}?filename=.github/ISSUE_TEMPLATE/bug_report.md',
  },
  'PR template': {
    name: 'PR template',
    category: 'community',
    why: 'A PR template ensures contributors describe their changes, link related issues, and confirm testing before review.',
    howToFix: 'Create .github/PULL_REQUEST_TEMPLATE.md with sections for description, related issues, and testing.',
    fixUrl: 'https://github.com/{owner}/{repo}/new/{branch}?filename=.github/PULL_REQUEST_TEMPLATE.md',
  },
  'Code of Conduct': {
    name: 'Code of Conduct',
    category: 'community',
    why: 'A code of conduct sets behavior expectations and makes the community welcoming for underrepresented groups.',
    howToFix: 'Adopt the Contributor Covenant or a similar code of conduct and place it as CODE_OF_CONDUCT.md.',
  ...
  'Funding configuration': {
    ...
    howToFix: 'Create .github/FUNDING.yml listing your funding platforms (GitHub Sponsors, Open Collective, etc.).',
    fixUrl: 'https://github.com/{owner}/{repo}/new/{branch}?filename=.github/FUNDING.yml',
    learnMoreUrl: 'https://docs.github.com/en/repositories/managing-your-repositorys-settings-and-features/customizing-your-repository/displaying-a-sponsor-button-in-your-repository',
  },
  'SUPPORT.md': {
    name: 'SUPPORT.md',
    category: 'community',
    why: 'A SUPPORT.md file directs users to the right channels for help, reducing noise in the issue tracker.',
    howToFix: 'Create a SUPPORT.md (or .github/SUPPORT.md) listing where users can get help: forums, Discord, Stack Overflow, etc.',
  ...
  'CONTRIBUTING.md exists': {
    ...
    howToFix: 'Create a CONTRIBUTING.md explaining how to set up the dev environment, run tests, and submit PRs.',
    fixUrl: 'https://github.com/{owner}/{repo}/new/{branch}?filename=CONTRIBUTING.md',
  },
  'CONTRIBUTING.md is substantial (>200 chars)': {
    ...
    howToFix: 'Expand CONTRIBUTING.md with sections on environment setup, coding standards, testing, and the PR process.',
  },
  'Good first issue label in templates': {
    ...
    howToFix: 'Add a "good first issue" label option to your issue templates or tag existing simple issues with this label.',
  },
  'README has Contributing section': {
    ...
    howToFix: 'Add a "## Contributing" section to your README linking to CONTRIBUTING.md or explaining the process inline.',
  },
  'Setup instructions in README': {
    ...
    howToFix: 'Add a "## Getting Started" or "## Installation" section with step-by-step instructions.',
  },
};
